...
def create_flags():
    ...
    f.DEFINE_integer('train_batch_size', 5, 'number of elements in a training batch')
    f.DEFINE_integer('dev_batch_size', 5, 'number of elements in a validation batch')
    f.DEFINE_integer('test_batch_size', 5, 'number of elements in a test batch')

    f.DEFINE_integer('export_batch_size', 5, 'number of elements per batch on the exported graph')
